...
public class TileEntityAdvancedWorkbench extends TileEntity implements ISidedInventory
{
    ...
    private void consumeWorkbenchItem(ItemStack item)
    {
        ...
        for (int i = 0; i < 27; ++i)
        {
            ...
            if (inventoryItem != null && inventoryItem.isItemEqual(item))
            {
                ...
                if (inventoryItem.getItem().hasContainerItem(inventoryItem))
                {
                    ItemStack containerItem = inventoryItem.getItem().getContainerItem(inventoryItem);
                    ...
                    if (containerItem != null)
                    {
                        ...
                        if (containerItem != null && !worldObj.isRemote)
                        {
                            ...
                            EntityItem spawnedEntity = new EntityItem(worldObj, (double)((float)this.xCoord + xRandom), (double)((float)this.yCoord + yRandom), (double)((float)this.zCoord + zRandom), new ItemStack(containerItem.getItem(), containerItem.stackSize, containerItem.getItemDamage()));
    ...
    {
        return this.hasCustomInventoryName() ? this.inventoryName :  "container.crafting.advanced";
    }
    ...
    public void readFromNBT(NBTTagCompound tagCompound)
    {
        ...
        {
            NBTTagCompound slotTagCompound = tagList.getCompoundTagAt(i);
    ...
    public void writeToNBT(NBTTagCompound tagCompound)
    {
        ...
        if (itemOverflow != null)
            tagCompound.setTag("ItemOverflow", itemOverflow.writeToNBT(new NBTTagCompound()));
    }
