...
public class RecipesRucksackDyes implements IRecipe
{
	/**
	...
	public boolean matches(InventoryCrafting par1InventoryCrafting, World par2World)
	{
		...
		for (int var5 = 0; var5 < par1InventoryCrafting.getSizeInventory(); ++var5)
		{
			...
			if (var6 != null)
			{
				if (var6.getItem() instanceof ItemRucksack)
				{
					ItemRucksack var7 = (ItemRucksack)var6.getItem();

					if (var7.isLinkedWithEnderChest || var3 != null)
					{
						return false;
					}
	...
	public ItemStack getCraftingResult(InventoryCrafting par1InventoryCrafting)
	{
		...
		for (var7 = 0; var7 < par1InventoryCrafting.getSizeInventory(); ++var7)
		{
			...
			if (var8 != null)
			{
				if (var8.getItem() instanceof ItemRucksack)
				{
					var6 = (ItemRucksack)var8.getItem();

					if (var6.isLinkedWithEnderChest || var2 != null)
					{
						return null;
					}
